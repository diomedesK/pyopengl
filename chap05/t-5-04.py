...
class Graphics(Base):
    ...
    def initialize(self):
        ...
        self.mat.addUniform("sampler2D", "texture1", [Texture("./images/grid.png").textureReference, 1])
        self.mat.addUniform("sampler2D", "texture2", [Texture("./images/crate.png").textureReference, 2])
